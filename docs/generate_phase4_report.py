...
cover_title = ParagraphStyle(
    "CoverTitle", fontName="Helvetica-Bold", fontSize=28, textColor=NAVY,
    alignment=1, spaceAfter=4,
)
cover_tagline = ParagraphStyle(
    "CoverTagline", fontName="Helvetica", fontSize=12, textColor=CYAN,
    alignment=1, spaceAfter=0,
)
cover_report_label = ParagraphStyle(
    "CoverReportLabel", fontName="Helvetica", fontSize=10, textColor=GREY,
    alignment=1, spaceAfter=4,
)
cover_phase = ParagraphStyle(
    "CoverPhase", fontName="Helvetica-Bold", fontSize=48, textColor=NAVY,
    alignment=1, spaceAfter=0,
)
cover_complete = ParagraphStyle(
    "CoverComplete", fontName="Helvetica-Bold", fontSize=16, textColor=NAVY,
    alignment=1, spaceAfter=0,
)
...
intro_style = ParagraphStyle(
    "Intro", fontName="Helvetica", fontSize=9.5, textColor=NAVY, leading=15,
    alignment=1, spaceAfter=6,
)
body_style = ParagraphStyle(
    "Body", fontName="Helvetica", fontSize=9.5, textColor=BLACK, leading=14,
    spaceAfter=6,
)
section_title = ParagraphStyle(
    "SectionTitle", fontName="Helvetica-Bold", fontSize=11, textColor=WHITE,
    spaceAfter=0, spaceBefore=0,
)
subsection_title = ParagraphStyle(
    "SubsectionTitle", fontName="Helvetica-Bold", fontSize=10.5, textColor=NAVY,
...
def build():
    ...
    story.append(milestone_table([
        ...
        ok("Notification email to info@bjptechnologies.co.tz via EmailMessage (reply-to set)"),
        ...
        ok("contact.html — jarallax banner, 3 info cards, Luminos form, inline errors, Google Map"),
        ok("Google Map updated to exact BJP Technologies coordinates (Mbezi, Dar es Salaam)"),
    ...
    story.append(generic_table(
        ...
        [
            [
                ...
                Paragraph("Database table — 10 fields, FK to Service, status choices.", cell_note),
            ],
            [
            ...
            [
                ...
                Paragraph("Branded confirmation — check icon, actions, phone fallback.", cell_note),
            ],
            [
                Paragraph("Migration 0001_initial", cell_bold),
                Paragraph("apps/contact/migrations/0001_initial.py", cell_body),
                Paragraph("ContactEnquiry table — applied locally, pending on cPanel.", cell_note),
            ],
        ],
        [40 * mm, 68 * mm, 66 * mm],
    ))
    ...
    story.append(generic_table(
        ...
        [
            ...
            [
                ...
                Paragraph("ContactView.form_valid() called if form passes validation.", cell_note),
            ],
            [
