...
def cover_page(canvas, doc):
    ...
    canvas.drawString(
        SIDEBAR_W + 10 * mm, PAGE_H * 0.475, "BJP Technologies (T) Limited — May 2026"
    )
    ...
    canvas.drawString(
        SIDEBAR_W + 16 * mm, PAGE_H * 0.415 + 4 * mm, "LIVE  ·  bjptechnologies.co.tz"
    )
    ...
    canvas.drawCentredString(
        (PAGE_W + SIDEBAR_W) / 2, PAGE_H * 0.20 + 10 * mm, "Secure Technology.  Scalable Growth."
    )
    canvas.setFillColor(GREY)
    canvas.setFont("Helvetica", 8)
    canvas.drawCentredString(
...
def build_styles():
    return {
        ...
        "caption": ParagraphStyle(
            "caption", fontName="Helvetica-Oblique", fontSize=8, textColor=GREY, spaceAfter=2 * mm
        ),
        "highlight": ParagraphStyle(
            "highlight", fontName="Helvetica-Bold", fontSize=10, textColor=BLUE, spaceAfter=3 * mm
        ),
        "green": ParagraphStyle(
            "green", fontName="Helvetica-Bold", fontSize=9.5, textColor=GREEN, spaceAfter=2 * mm
        ),
        ...
        cell_data.append(
            Table(
                [
                    [
                        Paragraph(
                            f'<font color="{col.hexval()}" size="20"><b>{val}</b></font>',
                            ParagraphStyle(
                                "k",
                                fontName="Helvetica-Bold",
                                fontSize=20,
                    ...
                    [
                        Paragraph(
                            label,
                            ParagraphStyle(
                                "kl", fontName="Helvetica", fontSize=8, textColor=GREY, alignment=1
                            ),
                        )
                    ],
                ],
...
def build_story(styles):
    ...
    google_data = [
        ...
        [
            "Google AI Overview",
            "Identifies BJP Technologies (T) Ltd as Tanzanian IT company",
            "✅ Featured",
        ],
    ...
    story.append(
        Paragraph("Three core SEO components were implemented in Phase 6:", styles["body"])
    )
    ...
    sitemap_data = [
        ...
        [
            "StaticViewSitemap",
            "Home, About, Services list, Industries list, Contact",
            "0.8",
            "Monthly",
        ],
    ...
    og_data = [
        ...
        [
            ...
            "{{ industry.name }} — BJP Technologies...",
            "/industries/<slug>/",
        ],
    ...
    story.append(
        Paragraph("<b>Content Security Policy (Phase 6 addition):</b>", styles["highlight"])
    )
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph("All pages were verified live during the Phase 6 audit session:", styles["body"])
    )
    pages_data = [
        ...
        [
            "bjptechnologies.co.tz/services/",
            "Our Services — BJP Technologies (T) Limited",
            "200 ✅",
        ],
        [
            "bjptechnologies.co.tz/industries/",
            "Industries We Serve — BJP Technologies (T) Ltd",
            "200 ✅",
        ],
        ["bjptechnologies.co.tz/contact/", "Contact Us — BJP Technologies (T) Limited", "200 ✅"],
        [
            "bjptechnologies.co.tz/services/<slug>/",
            "7 service detail pages (e.g. Cybersecurity)",
            "200 ✅",
        ],
        [
            "bjptechnologies.co.tz/industries/<slug>/",
            "6 industry detail pages (e.g. Healthcare)",
            "200 ✅",
        ],
        ...
        [
            "bjptechnologies.co.tz/robots.txt",
    ...
    admin_features = [
        ...
        [
            ...
            "4 metric cards: Active Services, Active Industries, Unread Enquiries, Total",
        ],
        ["Enquiry Status Panel", "Breakdown of new/read/replied with segmented progress bar"],
        [
            "Recent Enquiries Feed",
            "Live list of last 6 enquiries with name, email, service, date, status badge",
        ],
    ...
    story.append(
        Paragraph("BJP Technologies (T) Limited website — all 6 phases complete:", styles["body"])
    )
    project_data = [
        ...
        [
            "6",
            "Polish & Launch",
            "Sitemap, robots.txt, OG tags, CSP, Google indexed 18 pages",
            "✅",
        ],
    ]
        ...
        [
            [
                Paragraph(
                    ...
                    ParagraphStyle(
                        "cta", fontName="Helvetica-Bold", fontSize=22, textColor=CYAN, alignment=1
                    ),
                )
            ],
            [
